...
figure;
subplot(1,3,1)
surf(R,Z,Br,'linestyle','none');colormap(jet);xlabel('R');ylabel('Z');view([0,90]);axis equal

subplot(1,3,2)
surf(R,Z,Bz,'linestyle','none');colormap(jet);xlabel('R');ylabel('Z');view([0,90]);axis equal

subplot(1,3,3)
surf(R,Z,Bphi,'linestyle','none');colormap(jet);xlabel('R');ylabel('Z');view([0,90]);axis equal
